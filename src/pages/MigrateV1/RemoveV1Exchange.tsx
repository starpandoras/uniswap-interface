...
import { DEFAULT_DEADLINE_FROM_NOW, WETH_EXTENDED } from '../../constants'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WETH_EXTENDED[chainId]) ? 'WETH' : token.symbol}/ETH V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${chainId && token.equals(WETH_EXTENDED[chainId]) ? 'WETH' : token.symbol
